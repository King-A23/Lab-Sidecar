...
def create_server(root: str | Path | None = None) -> Any:
    ...
    server.tool()(tools.delegate_experiment_artifacts)
    server.tool()(tools.inspect_sidecar_task)
    server.tool()(tools.preview_sidecar_artifact)
    server.tool()(tools.cancel_sidecar_task)
